...
```bash
wget https://github.com/rzorzal/.c.env/releases/download/v0.1.0/cenv-Linux-x86_64.tar.gz
...
```bash
wget https://github.com/rzorzal/.c.env/releases/download/v0.1.0/cenv-Darwin-aarch64.tar.gz
...
```bash
wget https://github.com/rzorzal/.c.env/releases/download/v0.1.0/cenv-Darwin-x86_64.tar.gz
