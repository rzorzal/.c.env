...
```bash
# Add the tap (once)
brew tap yourusername/cenv https://github.com/yourusername/c.env.lang
...
Download the `.deb` package from the [releases page](https://github.com/yourusername/c.env.lang/releases):
...
Download pre-built binaries from the [releases page](https://github.com/yourusername/c.env.lang/releases):

### Linux (x86_64)

```bash
wget https://github.com/yourusername/c.env.lang/releases/download/v0.1.0/cenv-Linux-x86_64.tar.gz
...
```bash
wget https://github.com/yourusername/c.env.lang/releases/download/v0.1.0/cenv-Darwin-aarch64.tar.gz
...
```bash
wget https://github.com/yourusername/c.env.lang/releases/download/v0.1.0/cenv-Darwin-x86_64.tar.gz
